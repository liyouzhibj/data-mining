package com.xhdsj.crawler.MyhttpClient;
...
public class HttpClientHelper {
    ...
    private static String sendHttpPost(HttpPost httpPost,String s) {
        ...
        try {
            ...
            if (HttpStatus.SC_OK == response.getStatusLine().getStatusCode()) {
                responseContent = EntityUtils.toString(entity, s);
                EntityUtils.consume(entity);
            }
    ...
    private static String sendHttpGet(HttpGet httpGet,String s) {
    ...
    public static String sendHttpPostCode(String httpUrl,String s) {
        // 创建httpPost
        HttpPost httpPost = new HttpPost(httpUrl);
        return sendHttpPost(httpPost,s);
    }
    /**
     * 发送 get请求
     * 
    ...
    public static String sendHttpGet(String httpUrl,String s) {
        // 创建get请求
        HttpGet httpGet = new HttpGet(httpUrl);
        return sendHttpGet(httpGet,s);
    }
    /**
     * 发送 get请求
     * 
